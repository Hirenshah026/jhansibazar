<div id="spinPopup" class="fixed inset-0 z-[999] flex items-center justify-center bg-slate-900/60 backdrop-blur-sm hidden p-4">
    <div class="bg-white w-full max-w-[320px] rounded-2xl shadow-xl overflow-hidden border border-gray-200">
        ...
        <div class="p-6">
            ...
            <div class="space-y-4">
                <div class="relative">
                    <input type="number" id="userMobile" 
                ...
                <button id="spinBtn" class="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-semibold py-3 rounded-lg transition-colors flex items-center justify-center gap-2">
