...
<div id="screen-detail" class="sr"
    ...
    <div style="padding:18px 16px 0">
                ...
                <div class="relative group flex items-center justify-center">
                    <a href="{{ url('/spin/' . $shopSlug) }}"
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none"
                            stroke="currentColor" stroke-width="2.5" class="animate-[spin_5s_linear_infinite]">
        ...
        <div
            ...
            <div style="display:flex;gap:2px" id="starRow"><span class="star">★</span><span class="star">★</span><span
                    class="star">★</span><span class="star">★</span><span class="star empty">★</span></div>
