                ...
                <div class="flex gap-3 items-center">
                    ...
                    <div class="relative flex flex-col items-center group">
                        <a href="tel:{{ $shop->mobile ?? '00' }}"
                            class="w-9 h-9 bg-blue-50 rounded-full flex items-center justify-center border border-blue-200 text-blue-600 hover:bg-blue-600 hover:text-white transition-all duration-300 shadow-sm">
                        ...
                        <div
                            class="absolute bottom-full mb-2 flex flex-col items-center opacity-0 group-hover:opacity-100 pointer-events-none group-hover:pointer-events-auto transition-all duration-200 translate-y-2 group-hover:translate-y-0 z-[999]">
                            <div
                                class="bg-slate-900 text-white text-[11px] font-bold px-3 py-1.5 rounded-lg whitespace-nowrap shadow-2xl">
                                <span class="text-blue-400 font-black">CALL:</span> {{ $shop->mobile ?? 'N/A' }}
                            </div>
                            <div class="w-2 h-2 -mt-1 rotate-45 bg-slate-900"></div>
                        </div>
                    </div>

                    <div class="relative flex flex-col items-center group">
                        <a href="https://wa.me/{{ $shop->whatsapp_number ?? '00' }}"
                            class="w-9 h-9 bg-green-50 rounded-full flex items-center justify-center border border-green-200 text-green-600 hover:bg-green-500 hover:text-white transition-all duration-300 shadow-sm">
                        ...
                        <div
                            ...
                            <div
                                ...
                                {{ $shop->whatsapp_number ?? '0000000000' }} {{ count($cleanOffers) }}
                            </div>
                            <div class="w-2 h-2 -mt-1 rotate-45 bg-slate-900"></div>
                        </div>
                    ...
                    <div class="relative group flex items-center justify-center">
                        ...
                        @if ($hasSpin)
                            ...
                            <div
                                class="absolute -top-8 left-1/2 -translate-x-1/2 invisible group-hover:visible opacity-0 group-hover:opacity-100 transition-all duration-200 z-30">
                                <div
                                    class="bg-slate-800 text-white text-[10px] font-bold px-2 py-1 rounded shadow-lg whitespace-nowrap uppercase tracking-tighter">
                                    Spin Available
                                </div>
                                <div class="w-1.5 h-1.5 bg-slate-800 rotate-45 -mt-1 mx-auto"></div>
                            </div>

                            <a href="{{ url('/spin/' . $shopSlug) }}" data-turbo-action="advance"
                                class="w-9 h-9 {{ $hasSpin ? 'bg-emerald-600 text-white shadow-lg shadow-emerald-100' : 'bg-slate-100 text-slate-400' }} rounded-xl flex items-center justify-center transition-all duration-300 active:scale-90 border {{ $hasSpin ? 'border-emerald-500' : 'border-slate-200' }}">

                                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24"
                                    fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"
                                    stroke-linejoin="round"
                                    class="{{ $hasSpin ? 'animate-[spin_5s_linear_infinite]' : '' }}">
